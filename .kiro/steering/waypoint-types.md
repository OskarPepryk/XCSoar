---
inclusion: fileMatch
fileMatchPattern: ['src/Engine/Waypoint/Waypoint.hpp', 'src/Waypoint/**', 'src/Renderer/WaypointIconRenderer.cpp', 'src/Look/Waypoint*', 'src/Dialogs/Waypoint/**', 'Data/resources.txt']
---
